...
func TestAssess(t *testing.T) {
	tests := []struct {
		...
		// ── Dew point / fog risk ──
		{
			...
			utm:        makeUTM([]float64{5}, []float64{5}, 5),
			ow:         makeOW(4),
			kp:         0,
			flyable:    false,
			dewPointOK: false,
		...
		{
			name:       "dew point proximity at exactly temp 7 no warn",
			utm:        makeUTM([]float64{7}, []float64{5}, 5),
			ow:         makeOW(6),
			kp:         0,
			flyable:    true,
			dewPointOK: true,
		...
		{
			name:       "dew point proximity at temp 6.9 warns",
			utm:        makeUTM([]float64{6.9}, []float64{5}, 5),
			ow:         makeOW(6),
			kp:         0,
			flyable:    false,
			dewPointOK: false,
